...
const Guide = () => (
  <div className="flex flex-col items-center justify-center min-h-full bg-slate-900 p-8">
    <div className="max-w-2xl w-full bg-slate-800 rounded-lg shadow-lg p-8 border border-slate-700/50">
